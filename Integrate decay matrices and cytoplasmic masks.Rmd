...
setwd("C:/Users/cmorrow5/Desktop/011420 2DG N1 Q and A/")
...
library(plyr)
library(dplyr)
filenames <- data.frame(read.csv('C:/Users/cmorrow5/Desktop/011420 2DG N1 Q and A/test_key.csv'))
...
###Set NAD(P)H file location####
path_stringN <- paste('C:/Users/cmorrow5/Desktop/011420 2DG N1 Q and A/', image_info$Folder, '/',image_info$NADH, sep = "")

###Set FAD file location####
path_stringF <- paste('C:/Users/cmorrow5/Desktop/011420 2DG N1 Q and A/', image_info$Folder, '/',image_info$FAD, sep = "")

###Set Mask file location####
path_stringM <- paste('C:/Users/cmorrow5/Desktop/011420 2DG N1 Q and A/Masks/',image_info$NADH, sep = "")
...
#redimg.t1 <- as.matrix(read.table(paste(path_stringN,"-Ch1-_t1.asc", sep = ""), header=FALSE))
cellmask <- as.matrix(readTIFF(paste(path_stringM,"_photons _cells.tiff", sep = ""), as.is = TRUE))
cytomask <- as.matrix(readTIFF(paste(path_stringM,"_photons _cyto.tiff", sep = ""), as.is = TRUE))
#nucmask <- readTIFF(paste(path_stringN,"_photons _nuclei.tiff", sep = ""), as.is = TRUE)
labmask <- as.matrix(readTIFF(paste(path_stringM,"_photons _cyto.tiff" , sep = ""), as.is = TRUE))
...
setwd("C:/Users/cmorrow5/Desktop/011420 2DG N1 Q and A/")
write.csv(final_output,"final_output_011420.csv")
